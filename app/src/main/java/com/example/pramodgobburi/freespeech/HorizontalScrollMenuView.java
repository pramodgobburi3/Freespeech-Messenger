...
import com.example.pramodgobburi.freespeech.ItemAdapter;
import com.example.pramodgobburi.freespeech.ItemAdapter;
...
public class HorizontalScrollMenuView extends LinearLayout {
    ...
    public View getViewByPosition(int position) {
        return recyclerView.findViewById(position);
    }


    public void addItem(String id, String text, String icon, int default_icon) {
        menuItems.add(new MenuItem(id, icon, default_icon, text));
    }
    ...
    public void addItem(String id, String text, String icon, int default_icon, boolean seleted) {
        menuItems.add(new MenuItem(id, icon, default_icon, text, seleted));
    }



    public void addItem(String id, String text, String icon, boolean seleted, int numNotifications, int default_icon) {
        menuItems.add(new MenuItem(id, icon, default_icon, text, seleted));
    ...
    public void addItem(String text, String icon, int default_icon, int numNotifications) {
        menuItems.get(menuItems.size() - 1).setNumNotifications(numNotifications);
        menuItems.get(menuItems.size() - 1).setNotifications(true);
    }
    ...
    public void editItem(int position, String text, String icon, boolean showNotifications, int numNotifications) {
